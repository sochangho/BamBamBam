...
public class VibrationOriginalSkill : VibrationActiveSkill
{
    ...
    public async UniTask WaveCreate()
    {
        ...
        {           
            ...
            await UniTask.Delay(System.TimeSpan.FromSeconds(0.1f), cancellationToken: snakePartOwner.GetCancellationTokenOnDestroy());
        }
    }
